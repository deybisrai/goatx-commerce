class Cart:
        ...
        if str(producto.id) not in self.cart.keys():
            ...
            for key,value in self.cart.items():
                if key == str(producto.id):
                    ...
                    value['subtotal'] = str(int(value['cantidad']) * float(value['precio']))
                    break
        self.save()
    ...
    def save(self):
        ...
        for key,value in self.cart.items():
            ...
            totalProductos +=int(value['cantidad'])

        self.session['cartMontoTotal'] = montoTotal
        self.session['cartCantidad'] = totalProductos
